module.exports = {
  ...
  app_name: "KIKOBA",
  app_price: "Free",
  app_description: "Get the most out of your VICOBA groups by having proper management and ease of management.",
  app_keywords: ["automatic", "gatsbyjs", "app", "landing page"],

  // Personal Info
  your_name: "Lockwood Technology",
  ...
  features: [
    ...
    {
      title: "Achive more of your life goals",
      description:
    ...
    {
      title: "Get good credit score to apply for even bigger loans",
      description:
    ...
    {
      title: " Get insuarence with ease",
      description:
